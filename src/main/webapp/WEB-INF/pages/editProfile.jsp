...
<body>
	...
	<div class="container">
		<br /> <img src="images/register.png" style="height: 150px;"
		...
		<hr />
		<span style="font-size: 18px; color: blue; font-weight: bold;">Edit
			Profile Page</span>
		<hr />
		<div style="width: 50%">
			<form action="updateProfile" method="post" enctype="multipart/form-data">
				...
				<input type="text" name="username" class="form-control"
					...
					value="${profileDTO.name}"> <label>Email</label> <input
					type="email" name="email" class="form-control"
					value="${profileDTO.email}"> <label>Gender</label> <select
					...
					class="form-control" value="${profileDTO.photo}"> 
